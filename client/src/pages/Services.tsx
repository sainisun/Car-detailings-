...
export default function Services() {
  return (
    <div className="page-shell">
      <PageIntro number="01" eyebrow="The full service menu" title="Choose your" accent="care route." lead="Washing, cleaning, polish, detailing, and mechanical workshop support for cars and pickups in Dadi, Rajasthan." image={assets.foamWash} />
